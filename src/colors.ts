...
export function getColors(provided: ThemeConfig) {
	...
	const editor = {
		...
		findMatchBackground: hexToHexAlpha(foreground, 0.15),
		...
		findRangeHighlightBackground: hexToHexAlpha(foreground, 0.1),
		findMatchBorder: hexToHexAlpha(foreground, 0.65),
		findMatchHighlightBorder: hexToHexAlpha(foreground, 0.1),
		findRangeHighlightBorder: hexToHexAlpha(foreground, 0.1),
